...
function BookingModal({ open, onClose }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setError("Could not reach the desk. Please call +91 98765 00005.");
    } finally {
      setSending(false);
    }
  };
    ...
    <>
      ...
      <div className={"bm-shell " + (open ? "open" : "")} role="dialog" aria-label="Schedule a viewing">
        <header className="bm-head">
          <div>
            <div className="bm-eyebrow"><span className="bm-rule"/>Empire Estates Property Consultants · Reservation Desk</div>
        ...
        {sent ? (
          ...
          <form className="bm-grid" onSubmit={submit}>
            ...
            <aside className="bm-col bm-col-summary">
              ...
              <Row k="Office"   v="Booth 274, Opp. Flower Market · Phase 7, Sector 61 · Chandigarh-Mohali · 160062" />
              ...
              <a href="tel:+919876500005" className="bm-call">Or call the desk · +91 98765 00005</a>
            </aside>
          </form>
        )}
      </div>
