/* ───────────────────── IntroTunnel ─────────────────────
   ...
   Sequence:
     ...
     2. 'reveal'  — tunnel ends on a clean screen; the
                    EMPIRE ESTATES PROPERTY CONSULTANTS lockup fades in
                    and holds.
     3. 'out'     — the whole thing dissolves (fade + scale +
                    blur) into the landing page.
     4. 'gone'    — unmounts and calls onDone().

   Customised for EMPIRE ESTATES PROPERTY CONSULTANTS (blue room, brand phrase).
*/
...
const PHRASE = 'EMPIRE ESTATES PROPERTY CONSULTANTS · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>EMPIRE ESTATES</span><span>REALTY</span></div>
